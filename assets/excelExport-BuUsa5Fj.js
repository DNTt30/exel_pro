import{r as e}from"./rolldown-runtime-hePW80VL.js";import{L as t,N as n,S as r,_ as i,k as a,n as o,nt as s,xt as c}from"./index-DtEYNEa_.js";import{t as l}from"./createLucideIcon-B9iogsml.js";import{t as u}from"./shallow-DPTV-2It.js";var d=l(`printer`,[[`path`,{d:`M6 18H4a2 2 0 0 1-2-2v-5a2 2 0 0 1 2-2h16a2 2 0 0 1 2 2v5a2 2 0 0 1-2 2h-2`,key:`143wyd`}],[`path`,{d:`M6 9V3a1 1 0 0 1 1-1h10a1 1 0 0 1 1 1v6`,key:`1itne7`}],[`rect`,{x:`6`,y:`14`,width:`12`,height:`8`,rx:`1`,key:`1ue0tg`}]]),f=e(c(),1);function p(e,t,n,c=null){let{employees:l,user:d,stores:p}=o(u(e=>({employees:e.employees,user:e.user,stores:e.stores}))),m=r(d);return(0,f.useMemo)(()=>{let r=l;if(e){let t=e.toLowerCase();r=r.filter(e=>e.name.toLowerCase().includes(t)||e.id.toLowerCase().includes(t))}n!==`ALL`&&(r=r.filter(e=>(e.role||e.type)===n));let o=new Set(i(d,p)),u=t&&o.has(t)?t:d?.dept,f=m?t:u||`ALL`,h={};if(r.forEach(e=>{if(h[e.dept]||(h[e.dept]=[]),h[e.dept].push({...e,isBorrowedTo:null}),c){let t=c[e.id]||{},n=new Set;s.forEach(r=>{let i=t[r],o=a(i);o&&o!==e.dept&&n.add(o)}),n.forEach(t=>{h[t]||(h[t]=[]),h[t].push({...e,isBorrowedTo:t})})}}),f&&f!==`ALL`){let e={};return h[f]&&(e[f]=h[f]),e}if(!m){let e={};return Object.keys(h).forEach(t=>{o.has(t)&&(e[t]=h[t])}),e}return h},[l,e,t,n,m,d,c,p])}function m({currentWeek:e,deptName:r,groupedEmps:i,weekSchedule:a}){let o=e.split(`-`),s=parseInt(o[0],10),c=parseInt(o[1],10),l=parseInt(o[2],10),u=[`T2`,`T3`,`T4`,`T5`,`T6`,`T7`,`CN`],d=new Date(s,c-1,l),f=u.map((e,t)=>{let n=new Date(d);n.setDate(d.getDate()+t);let r=n.getDate().toString().padStart(2,`0`),i=(n.getMonth()+1).toString().padStart(2,`0`);return{dayKey:e,dateStr:`${r}/${i}`,header:`${e} (${r}/${i})`}}),p=new Date(d);p.setDate(d.getDate()+6);let m=`${`${d.getDate().toString().padStart(2,`0`)}/${(d.getMonth()+1).toString().padStart(2,`0`)}`} → ${`${p.getDate().toString().padStart(2,`0`)}/${(p.getMonth()+1).toString().padStart(2,`0`)}`}/${s}`,h=e=>{if(!e)return`color: #94a3b8;`;let{shift:t,covering_store:r}=n(e);return!t||t===`off`?`color: #94a3b8;`:r?`background-color: #fef08a; color: #854d0e; font-weight: bold;`:t===`6-14`?`background-color: #bbf7d0; color: #166534; font-weight: bold;`:t===`14-22`?`background-color: #bfdbfe; color: #1e40af; font-weight: bold;`:t===`10-18`?`background-color: #fed7aa; color: #9a3412; font-weight: bold;`:t===`22-6`?`background-color: #fecaca; color: #991b1b; font-weight: bold;`:`background-color: #e2e8f0; color: #334155; font-weight: bold;`},g=``,_=1;Object.entries(i).forEach(([e,r])=>{g+=`
