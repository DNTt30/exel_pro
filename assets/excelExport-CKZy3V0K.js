import{r as e}from"./rolldown-runtime-hePW80VL.js";import{N as t,O as n,St as r,d as i,n as a,rt as o,s}from"./index-BPiaegU9.js";import{t as c}from"./createLucideIcon-C0zLX93C.js";import{t as l}from"./shallow-BQ7_vS8_.js";var u=c(`printer`,[[`path`,{d:`M6 18H4a2 2 0 0 1-2-2v-5a2 2 0 0 1 2-2h16a2 2 0 0 1 2 2v5a2 2 0 0 1-2 2h-2`,key:`143wyd`}],[`path`,{d:`M6 9V3a1 1 0 0 1 1-1h10a1 1 0 0 1 1 1v6`,key:`1itne7`}],[`rect`,{x:`6`,y:`14`,width:`12`,height:`8`,rx:`1`,key:`1ue0tg`}]]),d=e(r(),1);function f(e,r,i,c=null){let{employees:u,user:f,stores:p}=a(l(e=>({employees:e.employees,user:e.user,stores:e.stores}))),m=t(f);return(0,d.useMemo)(()=>{let t=u;if(e){let n=e.toLowerCase();t=t.filter(e=>e.name.toLowerCase().includes(n)||e.id.toLowerCase().includes(n))}i!==`ALL`&&(t=t.filter(e=>(e.role||e.type)===i));let a=new Set(n(f,p)),l=r&&a.has(r)?r:f?.dept,d=m?r:l||`ALL`,h={};if(t.forEach(e=>{if(h[e.dept]||(h[e.dept]=[]),h[e.dept].push({...e,isBorrowedTo:null}),c){let t=c[e.id]||{},n=new Set;o.forEach(r=>{let i=t[r],a=s(i);a&&a!==e.dept&&n.add(a)}),n.forEach(t=>{h[t]||(h[t]=[]),h[t].push({...e,isBorrowedTo:t})})}}),d&&d!==`ALL`){let e={};return h[d]&&(e[d]=h[d]),e}if(!m){let e={};return Object.keys(h).forEach(t=>{a.has(t)&&(e[t]=h[t])}),e}return h},[u,e,r,i,m,f,c,p])}function p({currentWeek:e,deptName:t,groupedEmps:n,weekSchedule:r,userName:a=`OFC`}){let o=e.split(`-`),s=parseInt(o[0],10),c=parseInt(o[1],10),l=parseInt(o[2],10),u=[`T2`,`T3`,`T4`,`T5`,`T6`,`T7`,`CN`],d={T2:`THỨ HAI`,T3:`THỨ BA`,T4:`THỨ TƯ`,T5:`THỨ NĂM`,T6:`THỨ SÁU`,T7:`THỨ BẢY`,CN:`CHỦ NHẬT`},f=new Date(s,c-1,l),p=u.map((e,t)=>{let n=new Date(f);n.setDate(f.getDate()+t);let r=n.getDate().toString(),i=r.padStart(2,`0`),a=(n.getMonth()+1).toString().padStart(2,`0`),o=n.getFullYear();return{dayKey:e,html:`${t===0?`${r}/${n.getMonth()+1}/${o}`:`${i}/${a}`}<br/>${d[e]}`}}),m=(e,t)=>{if(!e)return`background-color: #FFFFFF; color: #000000;`;let{shift:n,covering_store:r}=i(e);if(!n||n.toLowerCase()===`off`)return`background-color: #FFFFFF; color: #000000;`;if(r)return`background-color: #FFFF00; color: #000000; font-weight: bold;`;let a=n.toLowerCase();return[`6-14`,`5-14`,`6-10`,`10-14`,`5-10`,`6-12`,`14-18h`].includes(a)||a.startsWith(`6-`)||a.startsWith(`5-`)||a===`10-14`?`background-color: #00FF00; color: #000000; font-weight: bold;`:[`14-22`,`14-18`,`18-22`,`10-18`,`14-22/22-6`,`14h-18h`].includes(a)||a.startsWith(`14-`)||a.startsWith(`18-`)||a.startsWith(`10-18`)?`background-color: #00FFFF; color: #000000; font-weight: bold;`:[`22-6`,`12-20`].includes(a)||a.startsWith(`22-`)?`background-color: #4169E1; color: #FFFFFF; font-weight: bold;`:t===`CSR_NEW`||t===`CSR NEW`?`background-color: #FF0000; color: #FFFFFF; font-weight: bold;`:`background-color: #FFFFFF; color: #000000; font-weight: bold;`},h=``;Object.entries(n).forEach(([e,t])=>{h+=`
    ...
    `,t.forEach(t=>{let n=r[t.id]||{},a=p.map(e=>{let r=n[e.dayKey]||``,{shift:a,covering_store:o}=i(r),s=a===`off`?`off`:a;return o&&(s+=` ${o}`),`<td style="border: 1px solid #000000; text-align: center; mso-number-format: '\\@'; ${m(r,t.type)}">${s||``}</td>`}).join(``);h+=`
        <tr>
