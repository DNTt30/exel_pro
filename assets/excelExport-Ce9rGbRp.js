import{r as e}from"./rolldown-runtime-hePW80VL.js";import{F as t,O as n,dt as r,jt as i,m as a,mt as o,pt as s,r as c,u as l}from"./index-qqEmlreo.js";import{t as u}from"./createLucideIcon-DC2doHWZ.js";import{t as d}from"./shallow-Cf0DMx42.js";var f=u(`printer`,[[`path`,{d:`M6 18H4a2 2 0 0 1-2-2v-5a2 2 0 0 1 2-2h16a2 2 0 0 1 2 2v5a2 2 0 0 1-2 2h-2`,key:`143wyd`}],[`path`,{d:`M6 9V3a1 1 0 0 1 1-1h10a1 1 0 0 1 1 1v6`,key:`1itne7`}],[`rect`,{x:`6`,y:`14`,width:`12`,height:`8`,rx:`1`,key:`1ue0tg`}]]),p=e(i(),1);function m(e,i,a,o=null){let{employees:s,user:u,stores:f}=c(d(e=>({employees:e.employees,user:e.user,stores:e.stores}))),m=t(u);return(0,p.useMemo)(()=>{let t=s;if(e){let n=e.toLowerCase();t=t.filter(e=>e.name.toLowerCase().includes(n)||e.id.toLowerCase().includes(n))}a!==`ALL`&&(t=t.filter(e=>(e.role||e.type)===a));let c=new Set(n(u,f,s)),d=i===`ALL`||i&&c.has(i)?i:u?.dept||`ALL`,p=m?i:d||`ALL`,h={};if(t.forEach(e=>{if(h[e.dept]||(h[e.dept]=[]),h[e.dept].push({...e,isBorrowedTo:null}),o&&p&&p!==`ALL`){let t=o[e.id]||{};r.forEach(n=>{let r=t[n];l(r)===p&&e.dept!==p&&(h[p]||(h[p]=[]),h[p].some(t=>t.id===e.id&&t.isBorrowedTo===p)||h[p].push({...e,isBorrowedTo:p}))})}}),p&&p!==`ALL`){let e={};return h[p]&&(e[p]=h[p]),e}if(!m){let e={};return Object.keys(h).forEach(t=>{c.has(t)&&(e[t]=h[t])}),e}return h},[s,e,i,a,m,u,o,f])}function h(e){if(e==null)return``;let t=String(e);if(!t)return``;let n=/^[=+\-@\t\r]/.test(t)||/^[=+\-@]/.test(t.trim()),r=t.replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`).replace(/"/g,`&quot;`).replace(/'/g,`&#39;`);return n?`'`+r:r}function g({currentWeek:e,deptName:t,groupedEmps:n,weekSchedule:i,userName:o=`OFC`}){let s=e.split(`-`),c=parseInt(s[0],10),l=parseInt(s[1],10),u=parseInt(s[2],10),d={T2:`THỨ HAI`,T3:`THỨ BA`,T4:`THỨ TƯ`,T5:`THỨ NĂM`,T6:`THỨ SÁU`,T7:`THỨ BẢY`,CN:`CHỦ NHẬT`},f=new Date(c,l-1,u),p=r.map((e,t)=>{let n=new Date(f);n.setDate(f.getDate()+t);let r=n.getDate().toString(),i=r.padStart(2,`0`),a=(n.getMonth()+1).toString().padStart(2,`0`),o=n.getFullYear();return{dayKey:e,html:`${t===0?`${r}/${n.getMonth()+1}/${o}`:`${i}/${a}`}<br/>${d[e]}`}}),m=(e,t)=>{if(!e)return`background-color: #FFFFFF; color: #000000;`;let{shift:n,covering_store:r}=a(e);if(!n||n.toLowerCase()===`off`)return`background-color: #FFFFFF; color: #000000;`;if(r)return`background-color: #FFFF00; color: #000000; font-weight: bold;`;let i=n.toLowerCase();return[`6-14`,`5-14`,`6-10`,`10-14`,`5-10`,`6-12`,`14-18h`].includes(i)||i.startsWith(`6-`)||i.startsWith(`5-`)||i===`10-14`?`background-color: #00FF00; color: #000000; font-weight: bold;`:[`14-22`,`14-18`,`18-22`,`10-18`,`14-22/22-6`,`14h-18h`].includes(i)||i.startsWith(`14-`)||i.startsWith(`18-`)||i.startsWith(`10-18`)?`background-color: #00FFFF; color: #000000; font-weight: bold;`:[`22-6`,`12-20`].includes(i)||i.startsWith(`22-`)?`background-color: #4169E1; color: #FFFFFF; font-weight: bold;`:t===`CSR_NEW`||t===`CSR NEW`?`background-color: #FF0000; color: #FFFFFF; font-weight: bold;`:`background-color: #FFFFFF; color: #000000; font-weight: bold;`},g=``;Object.entries(n).forEach(([e,t])=>{g+=`
    ...
    `,t.forEach(t=>{let n=i[t.id]||{},r=p.map(e=>{let r=n[e.dayKey]||``,{shift:i,covering_store:o}=a(r),s=i===`off`?`off`:i;return o&&(s+=` ${o}`),`<td style="border: 1px solid #000000; text-align: center; mso-number-format: '\\@'; ${m(r,t.type)}">${h(s)}</td>`}).join(``);g+=`
        <tr>
