import{r as e}from"./rolldown-runtime-hePW80VL.js";import{At as t,I as n,d as r,dt as i,k as a,mt as o,n as s,pt as c,s as l}from"./index-Dq8Bd5Ol.js";import{t as u}from"./createLucideIcon-BoWUfwZy.js";import{t as d}from"./shallow-CIiKcFl0.js";var f=u(`printer`,[[`path`,{d:`M6 18H4a2 2 0 0 1-2-2v-5a2 2 0 0 1 2-2h16a2 2 0 0 1 2 2v5a2 2 0 0 1-2 2h-2`,key:`143wyd`}],[`path`,{d:`M6 9V3a1 1 0 0 1 1-1h10a1 1 0 0 1 1 1v6`,key:`1itne7`}],[`rect`,{x:`6`,y:`14`,width:`12`,height:`8`,rx:`1`,key:`1ue0tg`}]]),p=e(t(),1);function m(e,t,r,o=null){let{employees:c,user:u,stores:f}=s(d(e=>({employees:e.employees,user:e.user,stores:e.stores}))),m=n(u);return(0,p.useMemo)(()=>{let n=c;if(e){let t=e.toLowerCase();n=n.filter(e=>e.name.toLowerCase().includes(t)||e.id.toLowerCase().includes(t))}r!==`ALL`&&(n=n.filter(e=>(e.role||e.type)===r));let s=new Set(a(u,f,c)),d=t===`ALL`||t&&s.has(t)?t:u?.dept||`ALL`,p=m?t:d||`ALL`,h={};if(n.forEach(e=>{if(h[e.dept]||(h[e.dept]=[]),h[e.dept].push({...e,isBorrowedTo:null}),o){let t=o[e.id]||{},n=new Set;i.forEach(r=>{let i=t[r],a=l(i);a&&a!==e.dept&&n.add(a)}),n.forEach(t=>{h[t]||(h[t]=[]),h[t].push({...e,isBorrowedTo:t})})}}),p&&p!==`ALL`){let e={};return h[p]&&(e[p]=h[p]),e}if(!m){let e={};return Object.keys(h).forEach(t=>{s.has(t)&&(e[t]=h[t])}),e}return h},[c,e,t,r,m,u,o,f])}function h({currentWeek:e,deptName:t,groupedEmps:n,weekSchedule:a,userName:o=`OFC`}){let s=e.split(`-`),c=parseInt(s[0],10),l=parseInt(s[1],10),u=parseInt(s[2],10),d={T2:`THỨ HAI`,T3:`THỨ BA`,T4:`THỨ TƯ`,T5:`THỨ NĂM`,T6:`THỨ SÁU`,T7:`THỨ BẢY`,CN:`CHỦ NHẬT`},f=new Date(c,l-1,u),p=i.map((e,t)=>{let n=new Date(f);n.setDate(f.getDate()+t);let r=n.getDate().toString(),i=r.padStart(2,`0`),a=(n.getMonth()+1).toString().padStart(2,`0`),o=n.getFullYear();return{dayKey:e,html:`${t===0?`${r}/${n.getMonth()+1}/${o}`:`${i}/${a}`}<br/>${d[e]}`}}),m=(e,t)=>{if(!e)return`background-color: #FFFFFF; color: #000000;`;let{shift:n,covering_store:i}=r(e);if(!n||n.toLowerCase()===`off`)return`background-color: #FFFFFF; color: #000000;`;if(i)return`background-color: #FFFF00; color: #000000; font-weight: bold;`;let a=n.toLowerCase();return[`6-14`,`5-14`,`6-10`,`10-14`,`5-10`,`6-12`,`14-18h`].includes(a)||a.startsWith(`6-`)||a.startsWith(`5-`)||a===`10-14`?`background-color: #00FF00; color: #000000; font-weight: bold;`:[`14-22`,`14-18`,`18-22`,`10-18`,`14-22/22-6`,`14h-18h`].includes(a)||a.startsWith(`14-`)||a.startsWith(`18-`)||a.startsWith(`10-18`)?`background-color: #00FFFF; color: #000000; font-weight: bold;`:[`22-6`,`12-20`].includes(a)||a.startsWith(`22-`)?`background-color: #4169E1; color: #FFFFFF; font-weight: bold;`:t===`CSR_NEW`||t===`CSR NEW`?`background-color: #FF0000; color: #FFFFFF; font-weight: bold;`:`background-color: #FFFFFF; color: #000000; font-weight: bold;`},h=``;Object.entries(n).forEach(([e,t])=>{h+=`
    ...
    `,t.forEach(t=>{let n=a[t.id]||{},i=p.map(e=>{let i=n[e.dayKey]||``,{shift:a,covering_store:o}=r(i),s=a===`off`?`off`:a;return o&&(s+=` ${o}`),`<td style="border: 1px solid #000000; text-align: center; mso-number-format: '\\@'; ${m(i,t.type)}">${s||``}</td>`}).join(``);h+=`
        <tr>
