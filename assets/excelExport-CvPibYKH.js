import{C as e,D as t,V as n,at as r,j as i,n as a,ot as o,v as s}from"./index-Jry3Jm9L.js";import{t as c}from"./createLucideIcon-DUGWKROc.js";import{t as l}from"./shallow-CWb22v_O.js";var u=c(`printer`,[[`path`,{d:`M6 18H4a2 2 0 0 1-2-2v-5a2 2 0 0 1 2-2h16a2 2 0 0 1 2 2v5a2 2 0 0 1-2 2h-2`,key:`143wyd`}],[`path`,{d:`M6 9V3a1 1 0 0 1 1-1h10a1 1 0 0 1 1 1v6`,key:`1itne7`}],[`rect`,{x:`6`,y:`14`,width:`12`,height:`8`,rx:`1`,key:`1ue0tg`}]]),d=o(r(),1);function f(t,r,i,o=null){let{employees:c,user:u}=a(l(e=>({employees:e.employees,user:e.user}))),f=s(u);return(0,d.useMemo)(()=>{let a=c;if(t){let e=t.toLowerCase();a=a.filter(t=>t.name.toLowerCase().includes(e)||t.id.toLowerCase().includes(e))}i!==`ALL`&&(a=a.filter(e=>(e.role||e.type)===i));let s=f?r:u?.dept,l={};if(a.forEach(t=>{if(l[t.dept]||(l[t.dept]=[]),l[t.dept].push({...t,isBorrowedTo:null}),o){let r=o[t.id]||{},i=new Set;n.forEach(n=>{let a=r[n],o=e(a);o&&o!==t.dept&&i.add(o)}),i.forEach(e=>{l[e]||(l[e]=[]),l[e].push({...t,isBorrowedTo:e})})}}),s&&s!==`ALL`){let e={};return l[s]&&(e[s]=l[s]),e}return l},[c,t,r,i,f,u?.dept,o])}function p({currentWeek:e,deptName:n,groupedEmps:r,weekSchedule:a}){let o=e.split(`-`),s=parseInt(o[0],10),c=parseInt(o[1],10),l=parseInt(o[2],10),u=[`T2`,`T3`,`T4`,`T5`,`T6`,`T7`,`CN`],d=new Date(s,c-1,l),f=u.map((e,t)=>{let n=new Date(d);n.setDate(d.getDate()+t);let r=n.getDate().toString().padStart(2,`0`),i=(n.getMonth()+1).toString().padStart(2,`0`);return{dayKey:e,dateStr:`${r}/${i}`,header:`${e} (${r}/${i})`}}),p=new Date(d);p.setDate(d.getDate()+6);let m=`${`${d.getDate().toString().padStart(2,`0`)}/${(d.getMonth()+1).toString().padStart(2,`0`)}`} → ${`${p.getDate().toString().padStart(2,`0`)}/${(p.getMonth()+1).toString().padStart(2,`0`)}`}/${s}`,h=e=>{if(!e)return`color: #94a3b8;`;let{shift:n,covering_store:r}=t(e);return!n||n===`off`?`color: #94a3b8;`:r?`background-color: #fef08a; color: #854d0e; font-weight: bold;`:n===`6-14`?`background-color: #bbf7d0; color: #166534; font-weight: bold;`:n===`14-22`?`background-color: #bfdbfe; color: #1e40af; font-weight: bold;`:n===`10-18`?`background-color: #fed7aa; color: #9a3412; font-weight: bold;`:n===`22-6`?`background-color: #fecaca; color: #991b1b; font-weight: bold;`:`background-color: #e2e8f0; color: #334155; font-weight: bold;`},g=``,_=1;Object.entries(r).forEach(([e,n])=>{g+=`
