import{r as e}from"./rolldown-runtime-hePW80VL.js";import{N as t,O as n,at as r,d as i,n as a,s as o,wt as s}from"./index-BktoayuE.js";import{t as c}from"./createLucideIcon-Bxo5z0LO.js";import{t as l}from"./shallow-D7a4RVRU.js";var u=c(`printer`,[[`path`,{d:`M6 18H4a2 2 0 0 1-2-2v-5a2 2 0 0 1 2-2h16a2 2 0 0 1 2 2v5a2 2 0 0 1-2 2h-2`,key:`143wyd`}],[`path`,{d:`M6 9V3a1 1 0 0 1 1-1h10a1 1 0 0 1 1 1v6`,key:`1itne7`}],[`rect`,{x:`6`,y:`14`,width:`12`,height:`8`,rx:`1`,key:`1ue0tg`}]]),d=e(s(),1);function f(e,i,s,c=null){let{employees:u,user:f,stores:p}=a(l(e=>({employees:e.employees,user:e.user,stores:e.stores}))),m=t(f);return(0,d.useMemo)(()=>{let t=u;if(e){let n=e.toLowerCase();t=t.filter(e=>e.name.toLowerCase().includes(n)||e.id.toLowerCase().includes(n))}s!==`ALL`&&(t=t.filter(e=>(e.role||e.type)===s));let a=new Set(n(f,p)),l=i&&a.has(i)?i:f?.dept,d=m?i:l||`ALL`,h={};if(t.forEach(e=>{if(h[e.dept]||(h[e.dept]=[]),h[e.dept].push({...e,isBorrowedTo:null}),c){let t=c[e.id]||{},n=new Set;r.forEach(r=>{let i=t[r],a=o(i);a&&a!==e.dept&&n.add(a)}),n.forEach(t=>{h[t]||(h[t]=[]),h[t].push({...e,isBorrowedTo:t})})}}),d&&d!==`ALL`){let e={};return h[d]&&(e[d]=h[d]),e}if(!m){let e={};return Object.keys(h).forEach(t=>{a.has(t)&&(e[t]=h[t])}),e}return h},[u,e,i,s,m,f,c,p])}function p({currentWeek:e,deptName:t,groupedEmps:n,weekSchedule:a,userName:o=`OFC`}){let s=e.split(`-`),c=parseInt(s[0],10),l=parseInt(s[1],10),u=parseInt(s[2],10),d={T2:`THỨ HAI`,T3:`THỨ BA`,T4:`THỨ TƯ`,T5:`THỨ NĂM`,T6:`THỨ SÁU`,T7:`THỨ BẢY`,CN:`CHỦ NHẬT`},f=new Date(c,l-1,u),p=r.map((e,t)=>{let n=new Date(f);n.setDate(f.getDate()+t);let r=n.getDate().toString(),i=r.padStart(2,`0`),a=(n.getMonth()+1).toString().padStart(2,`0`),o=n.getFullYear();return{dayKey:e,html:`${t===0?`${r}/${n.getMonth()+1}/${o}`:`${i}/${a}`}<br/>${d[e]}`}}),m=(e,t)=>{if(!e)return`background-color: #FFFFFF; color: #000000;`;let{shift:n,covering_store:r}=i(e);if(!n||n.toLowerCase()===`off`)return`background-color: #FFFFFF; color: #000000;`;if(r)return`background-color: #FFFF00; color: #000000; font-weight: bold;`;let a=n.toLowerCase();return[`6-14`,`5-14`,`6-10`,`10-14`,`5-10`,`6-12`,`14-18h`].includes(a)||a.startsWith(`6-`)||a.startsWith(`5-`)||a===`10-14`?`background-color: #00FF00; color: #000000; font-weight: bold;`:[`14-22`,`14-18`,`18-22`,`10-18`,`14-22/22-6`,`14h-18h`].includes(a)||a.startsWith(`14-`)||a.startsWith(`18-`)||a.startsWith(`10-18`)?`background-color: #00FFFF; color: #000000; font-weight: bold;`:[`22-6`,`12-20`].includes(a)||a.startsWith(`22-`)?`background-color: #4169E1; color: #FFFFFF; font-weight: bold;`:t===`CSR_NEW`||t===`CSR NEW`?`background-color: #FF0000; color: #FFFFFF; font-weight: bold;`:`background-color: #FFFFFF; color: #000000; font-weight: bold;`},h=``;Object.entries(n).forEach(([e,t])=>{h+=`
    ...
    `,t.forEach(t=>{let n=a[t.id]||{},r=p.map(e=>{let r=n[e.dayKey]||``,{shift:a,covering_store:o}=i(r),s=a===`off`?`off`:a;return o&&(s+=` ${o}`),`<td style="border: 1px solid #000000; text-align: center; mso-number-format: '\\@'; ${m(r,t.type)}">${s||``}</td>`}).join(``);h+=`
        <tr>
