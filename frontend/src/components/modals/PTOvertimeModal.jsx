...
export default function PTOvertimeModal({ isOpen, onClose }) {
  ...
  return (
    ...
    >
      {/* Header Modal */}
      <div className="p-4 sm:p-5 bg-gradient-to-r from-red-600 via-rose-600 to-amber-600 text-white flex items-center justify-between shadow-xs flex-shrink-0">
        ...
        <button 
          type="button"
          onClick={onClose} 
          className="text-white/80 hover:text-white p-1.5 rounded-lg hover:bg-white/10 transition-colors font-bold text-sm cursor-pointer"
        >
          ✕
        </button>
      </div>
