...
/**
 * H�m d?i so�t t�nh gi? t? c?p timestamp (punchIn, punchOut).
 * Gi?i quy?t c�c b�i to�n ca qua d�m, ca qua th�ng, v� ph�t hi?n thi?u ch?m c�ng.
 */
export function calculatePunchHours(punchIn, punchOut, scheduledHours = null) {
  ...
  // N?u ra s? �m do l?i ch? ghi gi? m� b? qua ng�y, t? d?ng c?ng th�m 1 ng�y
